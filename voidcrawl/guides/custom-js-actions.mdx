...
```python
from void_crawl.actions import JsActionNode, inline_js
...
```python
from void_crawl.actions import ActionNode, Tab
...
```python
from void_crawl.actions import JsActionNode, load_js
...
flow = Flow([
    ScrollTo(0, 0),
    SetInputValue("#search", "void crawl"),
    ClickElement("#submit"),
    GetText("#results"),
])
