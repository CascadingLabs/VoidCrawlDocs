...
- [Cookbook: Combining headers with stealth](/voidcrawl/guides/cookbook/#combining-set_headers-with-stealth-mode) -- layer custom HTTP headers on top of stealth patches
- [Cookbook: Per-tab fingerprints](/voidcrawl/guides/cookbook/#per-tab-fingerprint-customisation-via-javascript) -- override timezone, screen, and WebGL per tab
- [Cookbook: Setting cookies](/voidcrawl/guides/cookbook/#setting-custom-cookies) -- inject cookies before navigating to a target domain
